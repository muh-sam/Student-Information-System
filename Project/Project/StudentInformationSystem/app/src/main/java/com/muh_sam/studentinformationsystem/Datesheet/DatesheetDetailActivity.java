...
public class DatesheetDetailActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            String datesheet = getIntent().getStringExtra(DATESHEETKEY);

            Bundle arguments = new Bundle();
            arguments.putString(DatesheetDetailActivity.DATESHEETKEY, datesheet);

            DatesheetDetailFragment fragment = new DatesheetDetailFragment();
            fragment.setArguments(arguments);

            getSupportFragmentManager().beginTransaction()
                    .add(R.id.datesheet_detail_container, fragment)
                    .commit();
        }
    }
